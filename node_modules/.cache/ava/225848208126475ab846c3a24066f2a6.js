...
var difP = (0, _pify2.default)(_imageDiff2.default);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            fsP.writeFile(_path2.default.join(__dirname, "results", 'result.jpg'), data);
            _context2.next = 11;
            return difP({
              actualImage: _path2.default.join(__dirname, "fixtures", 'fixture.jpg'),
              expectedImage: _path2.default.join(__dirname, "results", 'result.jpg'),
              diffImage: _path2.default.join(__dirname, "results", 'diff.jpg')
            });

          case 11:
            diff = _context2.sent;

            t.false(_rec3._expr(_rec3._capt(diff, 'arguments/0'), {
              content: 't.false(diff)',
              filepath: 'test.js',
              line: 38,
              async: true
            }));
...
//# sourceMappingURL=node_modules/.cache/ava/225848208126475ab846c3a24066f2a6.js.map